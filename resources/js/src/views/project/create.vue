<template>
    <div>
        <div v-if="can('create-project')" class="vx-col w-full mb-base">
            <vx-card ref="create" title="Personal Information">
                ...
                <vs-row vs-align="center" vs-type="flex" vs-justify="center" vs-w="12">
                    <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="12">
                        <vs-button id="btn-create" :disabled="!validateForm" @click="is_requesting?$store.dispatch('viewWaitMessage', $vs):create()" icon-pack="feather" icon="icon-save" type="gradient">Create Project</vs-button>
                    </vs-col>
                </vs-row>
            </vx-card>
        </div>
    ...
    export default {
        ...
        methods: {
            create() {
                ...
                this.$store.dispatch('project/create', form_data)
                    .then(response => {
                        this.is_requesting=false;
                        this.$vs.loading.close(`#btn-create > .con-vs-loading`);
                        this.$router.push(`/dashboard/project/${response.data.data.data.id}`);
                        this.$vs.notify({
                            title: 'Success',
